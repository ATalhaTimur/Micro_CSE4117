...
//========================================   FIRST PASS  ======================================================
            while (token)
            {
                ...
                } else if (strcmp(token, "call") == 0) //-------------- CALL -----------------------------
                {
                    ...
                    program[counter] = 0xa000;               
                    counter++;
                } else if (strcmp(token, "ret") == 0) { //-------------- RETURN -----------------------------
                    //to be added
                    program[counter] = 0xb000;
                    counter++;

                } else if (strcmp(token, "sti") == 0) { //-------------- SET INTERRUPT ----------------
                    program[counter] = 0xc000;
                    counter++;

                } else if (strcmp(token, "cli") == 0) { //-------------- CLEAR INTERRUPT ----------------
                    program[counter] = 0xd000;
                    counter++;

                } else if (strcmp(token, "iret") == 0) { //-------------- INTERRUPT RETURN ----------------
